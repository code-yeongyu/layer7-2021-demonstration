            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "p",
                        null,
                        "공부하고자 하는 열정, 보안인으로서의 책임감, 학교 선후배로서의 친근함은 동아리의 지향점입니다."
                    )
                ),
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "p",
                        null,
                        "Layer7은 선린인터넷고등학교가 서울시 최초 IT 특성화 고등학교로 지정된 2001년 부터 학교와 함께해 왔습니다. 보안에 관심 있는 학생들끼리 모여 동아리를 만들고, 해킹이라는 흔치 않은 분야에서 서로가 서로를 도우며 보안을 공부해왔습니다. 체계적인 커리큘럼과 동아리원들의 열정, 책임감은 20년이라는 역사를 뒷받침해왔습니다."
                    )
                ),
